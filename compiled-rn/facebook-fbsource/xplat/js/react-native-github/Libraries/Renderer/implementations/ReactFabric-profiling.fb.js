...
function getListeners(
  ...
  inst = getFiberCurrentPropsFromNode$1(stateNode);
  if (null === inst) return null;
  if ((inst = inst[registrationName]) && "function" !== typeof inst)
    throw Error(
      "Expected `" +
...
getFiberCurrentPropsFromNode$1 = function (inst) {
...
var ReactFabricHostComponent = (function () {
  function ReactFabricHostComponent(
    ...
    this._eventListeners = this.viewConfig = void 0;
    this._nativeTag = tag;
  ...
  _proto.unstable_getBoundingClientRect = function () {
    var stateNode = this._internalInstanceHandle.stateNode;
    return null != stateNode &&
      (stateNode = fabricGetBoundingClientRect(stateNode.node))
      ? new DOMRect(stateNode[0], stateNode[1], stateNode[2], stateNode[3])
      : new DOMRect(0, 0, 0, 0);
  };
    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$71.lanes | child$71.childLanes),
          (subtreeFlags |= child$71.subtreeFlags & 14680064),
          (subtreeFlags |= child$71.flags & 14680064),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$70.subtreeFlags & 14680064),
          (subtreeFlags |= treeBaseDuration$70.flags & 14680064),
  ...
  switch (workInProgress.tag) {
    ...
    case 5:
      ...
      if (null !== current && null != workInProgress.stateNode)
        ...
        renderLanes = new ReactFabricHostComponent(
          renderLanes,
          type,
          newProps,
          workInProgress
        );
        renderLanes = { node: current, canonical: renderLanes };
  ...
  try {
    ...
    if (null !== ref) {
      ...
      switch (current.tag) {
        ...
        case 27:
        case 5:
          var instanceToUse = instance.canonical;
          break;
        default:
  ...
  switch (finishedWork.tag) {
    ...
    case 22:
      flags & 512 &&
        null !== current &&
        safelyDetachRef(current, current.return);
      var isHidden$104 = null !== finishedWork.memoizedState,
        wasHidden$105 = null !== current && null !== current.memoizedState;
      if (finishedWork.mode & 1) {
        var prevOffscreenSubtreeIsHidden = offscreenSubtreeIsHidden,
          prevOffscreenSubtreeWasHidden = offscreenSubtreeWasHidden;
        offscreenSubtreeIsHidden = prevOffscreenSubtreeIsHidden || isHidden$104;
        offscreenSubtreeWasHidden =
          prevOffscreenSubtreeWasHidden || wasHidden$105;
        recursivelyTraverseMutationEffects(root, finishedWork);
        offscreenSubtreeWasHidden = prevOffscreenSubtreeWasHidden;
        offscreenSubtreeIsHidden = prevOffscreenSubtreeIsHidden;
      ...
      switch (didTimeout) {
        ...
        case 4:
          ...
          for (originallyAttemptedLanes = -1; 0 < lanes; )
            (errorRetryLanes$110 = 31 - clz32(lanes)),
              (errorRetryLanes = 1 << errorRetryLanes$110),
              (errorRetryLanes$110 = didTimeout[errorRetryLanes$110]),
              errorRetryLanes$110 > originallyAttemptedLanes &&
                (originallyAttemptedLanes = errorRetryLanes$110),
              (lanes &= ~errorRetryLanes);
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_1078 = {
