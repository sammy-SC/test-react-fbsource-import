...
function use(usable) {
  if (null !== usable && "object" === typeof usable) {
    if ("function" === typeof usable.then) {
      ...
      return trackUsedThenable(thenableState, usable, index$28);
    }
    if (
      ...
      switch (didTimeout) {
        ...
        case 4:
          ...
          for (originallyAttemptedLanes = -1; 0 < lanes; )
            (errorRetryLanes$100 = 31 - clz32(lanes)),
              (errorRetryLanes = 1 << errorRetryLanes$100),
              (errorRetryLanes$100 = didTimeout[errorRetryLanes$100]),
              errorRetryLanes$100 > originallyAttemptedLanes &&
                (originallyAttemptedLanes = errorRetryLanes$100),
              (lanes &= ~errorRetryLanes);
