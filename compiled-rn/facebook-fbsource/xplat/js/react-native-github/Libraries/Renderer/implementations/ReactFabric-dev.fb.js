...
function getFiberCurrentPropsFromNode(inst) {
...
var nextReactTag = 2; // TODO?: find a better place for this type to live
...
var ReactFabricHostComponent = /*#__PURE__*/ (function () {
  ...
  _proto.unstable_getBoundingClientRect =
    function unstable_getBoundingClientRect() {
      ...
      if (stateNode != null) {
        var rect = fabricGetBoundingClientRect(stateNode.node);
  ...
  _proto.addEventListener_unstable = function addEventListener_unstable(
    eventType,
    listener,
    options // $FlowFixMe[missing-local-annot]
  ) {
...
var ReactVersion = "18.3.0-next-2cc54b57e-20230220";
