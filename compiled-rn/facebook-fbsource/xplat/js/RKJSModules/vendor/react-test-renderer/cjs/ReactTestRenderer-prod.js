  ...
  if (didBailout)
    for (var child$60 = completedWork.child; null !== child$60; )
      (newChildLanes |= child$60.lanes | child$60.childLanes),
        (subtreeFlags |= child$60.subtreeFlags & 14680064),
        (subtreeFlags |= child$60.flags & 14680064),
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        cache$64 !== JSCompiler_inline_result && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
        renderLanes &&
    ...
    case 19:
      ...
      cache$64 = JSCompiler_inline_result.rendering;
      if (null === cache$64)
        ...
        JSCompiler_inline_result.isBackwards
          ...
          : ((current = JSCompiler_inline_result.last),
            null !== current
              ...
              : (workInProgress.child = cache$64),
            (JSCompiler_inline_result.last = cache$64));
      }
...
function commitMutationEffectsOnFiber(finishedWork, root) {
  ...
  switch (finishedWork.tag) {
    ...
    case 22:
      ...
      var wasHidden$96 = null !== current && null !== current.memoizedState;
      if (finishedWork.mode & 1) {
        ...
        offscreenSubtreeWasHidden =
          prevOffscreenSubtreeWasHidden || wasHidden$96;
        recursivelyTraverseMutationEffects(root, finishedWork);
        offscreenSubtreeWasHidden = prevOffscreenSubtreeWasHidden;
        offscreenSubtreeIsHidden = prevOffscreenSubtreeIsHidden;
      ...
      if (
        ...
        a: for (current = null, wasHidden$96 = finishedWork; ; ) {
          if (5 === wasHidden$96.tag) {
            if (null === current) {
              current = wasHidden$96;
              try {
                (type = wasHidden$96.stateNode),
                  existingHiddenCallbacks
                    ? (type.isHidden = !0)
                    : (wasHidden$96.stateNode.isHidden = !1);
              } catch (error) {
                captureCommitPhaseError(
                  finishedWork,
                  finishedWork.return,
          ...
          } else if (6 === wasHidden$96.tag) {
            if (null === current)
              try {
                wasHidden$96.stateNode.isHidden = existingHiddenCallbacks
                  ? !0
                  : !1;
              } catch (error$82) {
                captureCommitPhaseError(
            ...
            ((22 !== wasHidden$96.tag && 23 !== wasHidden$96.tag) ||
              null === wasHidden$96.memoizedState ||
              wasHidden$96 === finishedWork) &&
            null !== wasHidden$96.child
          ) {
            wasHidden$96.child.return = wasHidden$96;
            wasHidden$96 = wasHidden$96.child;
            continue;
          }
          if (wasHidden$96 === finishedWork) break a;
          for (; null === wasHidden$96.sibling; ) {
            if (
              null === wasHidden$96.return ||
              wasHidden$96.return === finishedWork
            )
              break a;
            current === wasHidden$96 && (current = null);
            wasHidden$96 = wasHidden$96.return;
          }
          current === wasHidden$96 && (current = null);
          wasHidden$96.sibling.return = wasHidden$96.return;
          wasHidden$96 = wasHidden$96.sibling;
        }
      flags & 4 &&
        ((flags = finishedWork.updateQueue),
        null !== flags &&
      ...
      switch (didTimeout) {
        ...
        case 4:
          ...
          for (originallyAttemptedLanes = -1; 0 < lanes; )
            (errorRetryLanes$104 = 31 - clz32(lanes)),
              (errorRetryLanes = 1 << errorRetryLanes$104),
              (errorRetryLanes$104 = didTimeout[errorRetryLanes$104]),
              errorRetryLanes$104 > originallyAttemptedLanes &&
                (originallyAttemptedLanes = errorRetryLanes$104),
              (lanes &= ~errorRetryLanes);
...
var devToolsConfig$jscomp$inline_979 = {
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1154 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1154.isDisabled &&
    hook$jscomp$inline_1154.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1154.inject(
        internals$jscomp$inline_1153
      )),
        (injectedHook = hook$jscomp$inline_1154);
    } catch (err) {}
}
